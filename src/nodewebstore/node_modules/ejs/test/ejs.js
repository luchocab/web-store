...
suite('include()', function () {
  ...
  test('work when nested', function () {
    var file = 'test/fixtures/nav.ejs';
    assert.equal(ejs.render(fixture('nav.ejs'), {pets: users}, {filename: file}),
        fixture('menu.html'));
  });
  ...
  test('work with a variable path', function () {
    ...
    assert.equal(ejs.render(fixture('nav.ejs'), {pets: users, varPath:  includePath}, {filename: file}),
      fixture('menu.html'));
  });
